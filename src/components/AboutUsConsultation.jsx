        ...
        <section className="main-consultation">
            <section className="main-consultation__connection">
                ...
                <p className="connection-subtitle">Укажите cвой номер телефона, мы перезвоним
                    ...
                    <span 
                        className="connection-subtitle-two"
                    >
                        Или позвоните нам сами — 
                    <a 
                        href="tel:+7 900 333 10 40" 
                        className="connection-subtitle__tel"
                    >
                        +7 900 333 10 40
                        </a>
                    </span>
                ...
                на <span className="personal-data">обработку своих персональных данных</span></p>
            </section>
