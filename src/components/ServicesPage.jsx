...
const ServicesPage = () => {
    ...
    const allOffers  = [
        ...
        {
            id: 10, 
            title: 'Съёмный аппарат', 
            price: '13 000 руб.', 
            category: 'braces'
        },
        {
            id: 11, 
            title: 'Ретенционная пластинка (капа)', 
            price: '10 000 руб.', 
            category: 'braces'
        },
        {
        ...
        {
            id: 15, 
            title: 'Увеличение объема костной ткани', 
            price: '25 000 руб.', 
            category: 'implants'
        },
        {
            id: 16, 
            title: 'Операция по установке 1-имплантата Apolonia (Южная Корея)', 
            price: '30 000 руб.', 
            category: 'implants'
        },
        {
        ...
        {
            id: 18, 
            title: 'MOCK — UP временный винир', 
            price: '2 500 руб.', 
            category: 'veneers'
        },
        {
            id: 19, 
            title: 'Винир керамический Е — МАХ Press с нанесением керамических слоёв', 
            price: '20 000 руб.', 
            category: 'veneers'
        },
        {
            id: 20, 
            title: 'Восстановление зуба вкладками, виниром, полукоронкои E-max', 
            price: '30 000 руб.', 
            category: 'veneers'
        },
        {
            id: 21, 
            title: 'Восстановление зуба коронкой постоянной металлокерамической стандартной', 
            price: '15 000 руб.', 
            category: 'crowns'
        },
        {
            id: 22, 
            title: 'Восстановление зуба коронкой временной прямым методом', 
            price: '1 000 руб.', 
            category: 'crowns'
        },
        {
            id: 23, 
            title: 'Установка коронки цельнолитой', 
            price: '3 900 руб.', 
            category: 'crowns'
        },
        {
            id: 24, 
            title: 'Восстановление зуба коронкой, полукоронкой постоянной цельнокерамической e.max «стандартная эстетика»', 
            price: '18 000 руб.', 
            category: 'crowns'
        },
        {
        ...
        <section className="services">
            ...
            <section className="services-display">
                <section className="services-display__header-buttons">
                    ...
                    <div 
                        className={activeButton === 'childrensDentistry' ? 
                        'header-buttons__childrensDentistry active' : 'header-buttons__childrensDentistry'}
                        onClick={() => { 
