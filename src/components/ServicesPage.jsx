...
const ServicesPage = () => {
    const [currentOffers, setCurrentOffers] = useState([
        {id: 1, title: 'Световая пломба', price: '1 000 руб.', category: 'dentalHeal'},
        {id: 2, title: 'Лечение кариеса', price: '2 000 руб.', category: 'dentalHeal'},
        {id: 3, title: 'Лечение пульпита', price: '3 000 руб.', category: 'dentalHeal'},
        {id: 4, title: 'Лечение кисты', price: '4 000 руб.', category: 'dentalHeal'}
    ]);
    ...
    const allOffers  = [
        {id: 1, title: 'Световая пломба', price: '1 200 руб.', category: 'dentalHeal'},
        {id: 2, title: 'Лечение кариеса', price: '2 000 руб.', category: 'dentalHeal'},
        {id: 3, title: 'Лечение пульпита', price: '3 500 руб.', category: 'dentalHeal'},
        {id: 4, title: 'Лечение кисты', price: '3 000 руб.', category: 'dentalHeal'},
        {id: 5, title: 'Ультразвук', price: '1 000 руб.', category: 'hygiene'},
        {id: 6, title: 'AirFlow', price: '1 200 руб.', category: 'hygiene'},
        {id: 7, title: 'Ремтерапия', price: '2 000 руб.', category: 'hygiene'},
        {id: 8, title: 'Полировка', price: '2 200 руб.', category: 'hygiene'},
        {id: 9, title: 'Металлические брекеты', price: '54 000 руб.', category: 'braces'},
        {id: 10, title: 'Съёмный аппарат', price: '13 000 руб.', category: 'braces'},
        {id: 11, title: 'Ретенционная пластинка (капа)', price: '10 000 руб.', buttonText: 'Записаться', category: 'braces'},
        {id: 12, title: 'Лечение зубов', price: '1 800 руб.', category: 'childrensDentistry'},
        {id: 13, title: 'Лечение десен', price: '1 500 руб.', category: 'childrensDentistry'},
        {id: 14, title: 'Удаление зуба', price: '2 000 руб.', category: 'childrensDentistry'},
        {id: 15, title: 'Увеличение объема костной ткани', price: '25 000 руб.', category: 'implants'},
        {id: 16, title: 'Операция по установке 1-имплантата Apolonia (Южная Корея)', price: '30 000 руб.', category: 'implants'},
        {id: 17, title: 'Имплантация All-on-4', price: '170 000 руб.', category: 'implants'},
        {id: 18, title: 'MOCK — UP временный винир', price: '2 500 руб.', category: 'veneers'},
        {id: 19, title: 'Винир керамический Е — МАХ Press с нанесением керамических слоёв', price: '20 000 руб.', category: 'veneers'},
        {id: 20, title: 'Восстановление зуба вкладками, виниром, полукоронкои E-max', price: '30 000 руб.', category: 'veneers'},
        {id: 21, title: 'Восстановление зуба коронкой постоянной металлокерамической стандартной', price: '15 000 руб.', category: 'crowns'},
        {id: 22, title: 'Восстановление зуба коронкой временной прямым методом', price: '1 000 руб.', category: 'crowns'},
        {id: 23, title: 'Установка коронки цельнолитой', price: '3 900 руб.', category: 'crowns'},
        {id: 24, title: 'Восстановление зуба коронкой, полукоронкой постоянной цельнокерамической e.max «стандартная эстетика»', price: '18 000 руб.', category: 'crowns'},
        {id: 25, title: 'Удаление зуба мудрости', price: '10 500 руб.', category: 'surgery'},
        {id: 26, title: 'Художественная реставрация зуба', price: '9 000 руб.', category: 'surgery'},
        {id: 27, title: 'Пломбирование канала', price: '6 700 руб.', category: 'surgery'},
        {id: 28, title: 'Вестибулопластика', price: '27 000 руб.', category: 'surgery'}
    ]
